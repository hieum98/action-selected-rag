...
4. **Direct Answer:** Provide a concise, direct answer to the question. Do not include explanations or extra commentary here.
5. **Output Format:** Respond in the following JSON structure with following fields:
